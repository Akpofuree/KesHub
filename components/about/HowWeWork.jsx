...
const features = [
  {
    id: 1,
    title: "Sourcing",
    description: "Bought directly from trusted brands and authorized distributors.",
...
const AppHeader = ({ title }) => (
  <div className="flex flex-col bg-white border-b border-gray-100 z-10 sticky top-0 shrink-0">
    ...
    <div className="flex items-center justify-center pb-3">
      <span className="font-bold text-sm text-gray-900 tracking-wide">{title}</span>
    </div>
  </div>
);
      ...
      <div className="flex flex-col h-full bg-[#FAFAFA]">
        ...
        <div className="p-4 flex-1 flex flex-col gap-3">
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-gray-900">Apple Authorized</p>
              <p className="text-xs text-gray-500 font-medium">Official Distributor</p>
            </div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">Verified Source</p>
            </div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-gray-900">Authentic Devices</p>
      ...
      <div className="flex flex-col h-full bg-[#FAFAFA]">
        ...
        <div className="p-4 flex-1 flex flex-col">
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm flex-1 flex flex-col">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-5">Inspection Checklist</p>
            <div className="space-y-5 flex-1">
              {['Screen & Display', 'Battery Health', 'Face ID / Biometrics', 'Cameras', 'Speakers & Mics'].map((item, i) => (
      ...
      <div className="flex flex-col h-full bg-[#FAFAFA]">
        ...
        <div className="p-4 flex-1 flex flex-col gap-4">
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm text-center relative overflow-hidden">
            ...
            <p className="text-xs font-medium text-gray-500 mb-1 mt-1">Device Price</p>
            <p className="text-3xl font-bold text-gray-900 tracking-tight">₦450,000</p>
          </div>
          
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Price Breakdown</p>
            <div className="space-y-4">
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500 font-medium">Market Average</span>
                <span className="text-gray-400 line-through font-semibold">₦485,000</span>
              </div>
              <div className="flex justify-between items-center text-sm">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="text-green-600 font-bold text-base">₦35,000</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col h-full bg-[#FAFAFA]">
        ...
        <div className="p-4 flex-1 flex flex-col gap-4">
          <div className="bg-gray-900 rounded-xl p-5 text-white shadow-lg">
            <p className="text-xs font-medium text-gray-400 mb-1">Target Budget</p>
          ...
          <div className="bg-white rounded-xl p-5 border border-green-100 shadow-sm relative overflow-hidden">
            ...
            <p className="text-base font-bold text-gray-900 mb-1">iPhone 13 Pro</p>
            <p className="text-xs font-medium text-gray-500 mb-4">128GB • Excellent Condition</p>
            
            <div className="flex items-center justify-between mt-2 pt-4 border-t border-gray-100">
              <span className="text-base font-bold text-gray-900">₦485,000</span>
        ...
        <div className="p-4 flex-1">
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm h-full">
            <div className="mb-6">
              ...
              <p className="text-lg font-bold text-gray-900">Tomorrow, 2:00 PM</p>
            </div>
            ...
            <div className="relative pl-4 space-y-7 mt-8">
              ...
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-none mb-1">Order Confirmed</p>
                  <p className="text-[10px] font-medium text-gray-400">Yesterday, 10:24 AM</p>
                </div>
              </div>
              <div className="relative z-10 flex items-start gap-4">
                <div className="w-4 h-4 rounded-full bg-green-500 border-4 border-white shadow-sm mt-0.5 shrink-0" />
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-none mb-1">Packed</p>
                  <p className="text-[10px] font-medium text-gray-400">Yesterday, 4:15 PM</p>
                </div>
              </div>
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-none mb-1">In Transit</p>
                  <p className="text-[10px] font-medium text-green-600">Arriving in Lagos Hub</p>
                </div>
              </div>
              <div className="relative z-10 flex items-start gap-4 opacity-40">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-500 leading-none">Out for Delivery</p>
                </div>
              </div>
            </div>
          </div>
    ...
    support: (
      <div className="flex flex-col h-full bg-[#FAFAFA]">
        ...
        <div className="p-4 flex-1 flex flex-col justify-end gap-3 pb-20 relative">
          ...
          >
            <p>Absolutely. It's at 96% maximum capacity. I've attached the 3CX diagnostic certificate for you.</p>
            <div className="bg-gray-50 rounded-xl p-2.5 flex items-center gap-2.5 border border-gray-100">
              ...
              <span className="text-[11px] font-bold text-gray-700">Diagnostic_Report.pdf</span>
            </div>
          </motion.div>
          ...
          <div className="absolute bottom-5 left-4 right-4 h-11 bg-white rounded-full border border-gray-200 shadow-sm flex items-center px-4 justify-between">
            <span className="text-[13px] font-medium text-gray-400">Message...</span>
    ...
    >
      <div className="max-w-[420px] mx-auto lg:mx-0 py-8 lg:py-0">
        <div className="relative mb-6 inline-block">
          ...
          >
            <feature.icon className={`w-7 h-7 ${isActive ? 'text-gray-900' : 'text-gray-400'}`} />
          </motion.div>
          {isActive && (
            <motion.div 
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <h2 className={`text-3xl font-bold tracking-tight transition-colors duration-500 ${isActive ? 'text-gray-900' : 'text-gray-500'}`}>
              {feature.title}
            </h2>
          ...
          <p className="text-[17px] text-gray-600 leading-relaxed mb-5 font-medium">
            {feature.description}
          </p>
          
          <div className="flex items-center gap-2.5 mt-2">
            <div className={`w-1.5 h-1.5 rounded-full transition-colors duration-500 ${isActive ? 'bg-green-500' : 'bg-gray-300'}`} />
            <p className="text-sm font-medium text-gray-500">
              {feature.subtext} <span className="text-gray-900 font-bold ml-1">{feature.stat}</span>
            </p>
          </div>
        </div>

        <div className="h-1 bg-gray-200/60 rounded-full mt-8 overflow-hidden">
          <motion.div
            initial={false}
            animate={{
...
export default function HowWeWork() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const viewportMiddle = isDesktop ? window.innerHeight / 2 : window.innerHeight * 0.7;
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#FAFAFA] py-24 sm:py-32">
      ...
      {/* Header */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 mb-16 lg:mb-24">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-center tracking-tight mb-5">
          How We Work
        </h1>
        <p className="text-lg md:text-xl text-gray-500 text-center font-medium max-w-2xl mx-auto">
