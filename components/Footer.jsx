    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Earphones", path: '/shop?search=Earbuds', icon: null },
                { text: "Headphones", path: '/shop?search=Headphones', icon: null },
                { text: "Smartphones", path: '/shop?search=Smartphones', icon: null },
                { text: "Laptops", path: '/shop?search=Laptops', icon: null },
            ]
        },
        {
            title: "WEBSITE",
        ...
        },
        {
            ...
            links: [
                ...
                { text: "contact@keshub.com", path: 'mailto:contact@keshub.com', icon: MailIcon },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to KES HUB, your destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © KES HUB All Right Reserved.
                </p>
            </div>
        </footer>
    );
