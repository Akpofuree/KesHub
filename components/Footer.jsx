      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-200 text-slate-600">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm text-slate-500">
              Welcome to KES HUB, your destination for the latest and smartest
              gadgets. From smartphones and smartwatches to essential
