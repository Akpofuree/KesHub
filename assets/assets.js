...
import { ClockFadingIcon, HeadsetIcon, SendIcon, ShieldCheck } from "lucide-react";
...
export const ourSpecsData = [
    { title: "Secure Payment", description: "Your transactions are protected with top-tier security for complete peace of mind.", icon: ShieldCheck, accent: '#05DF72' },
